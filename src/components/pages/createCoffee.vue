<template>
  <div class="mt-16">
    ...
    <section
      class="mx-5 mt-16 flex flex-col sm:flex-row sm:justify-between lg:justify-center "
      v-if="!collectiveId"
    >
      <CoffeeCard
        class="mb-10 coffeecard lg:mx-10"
        v-for="coffee in coffeCollective"
        :key="coffee.id"
        :data="coffee"
      ></CoffeeCard>
    </section>
    <div class="lg:flex lg:justify-center">
        <section class="mx-10 flex flex-col coffeeTypeMax lg:w-full" v-if="collectiveId">
        <CoffeeType
            v-for="coffeeType in coffeeTypes"
            @click="addCoffee(coffeeType.id)"
            :key="coffeeType.name"
            :data="coffeeType"
        ></CoffeeType>
        </section>
...
export default {
  ...
  methods: {
    addCoffee(methodId) {
      let currentCollective = this.coffeCollective.find(
        (e) => e.id == this.collectiveId
      );
            ...
            steps: [
              {
                ...
                img: "ncl4omsr.png",
                text:
                  '"Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime mollitia,molestiae quas vel sint commodi repudiandae consequuntur voluptatum laborumnumquam blanditiis harum quisquam eius sed odit fugiat iusto fuga praesentiumoptio, eaque rerum! Provident similique accusantium nemo autem. Veritatis"',
              },
              {
                header: "This is a header",
                id: 2,
      ...
      coffeCollective: [
        {
          ...
          name: "KIENI ESPRESSO",
          description:
            "Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime mollitiamolestiae quas vel sint commodi",
          process: "Washed",
          roastProfile: "Medium",
